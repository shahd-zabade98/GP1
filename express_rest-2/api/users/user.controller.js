...
const { create, getUsersByUserName,getIdfromUsername,insert_page,add_location,page_fetch,change_Bool } = require("./user.service");
   ...
   createUser: (req, res) =>{
    ...
    getid : (req, res) =>{
      ...
      const user_name = req.body.user_name;
          ...
          getIdfromUsername(user_name , ( err,results) => {  
